...
void main() async {
  ...
  late AlgoliaTask taskAdded, taskUpdated, taskDeleted, taskBatch, taskReplace, taskClearIndex, taskDeleteIndex;
  ...
  test('2. Perform Get Object to existing Index.', () async {
    addedObject = await algolia.instance.index('contacts').object(taskAdded.data['objectID'].toString()).getObject();
  ...
  test('7. Perform Multiple Queries', () async {
    var queryA = algolia.instance.index('contacts').search('john');
    var queryB = algolia.instance.index('contacts_alt').search('jo');
  ...
  test('10. Get Settings of "contacts" index', () async {
    var settings = await (algolia.instance.index('contacts').settings.getSettings() as Future<Map<String, dynamic>>);
  ...
  test('14. Perform Delete Indexes.', () async {
    ...
    taskDeleteIndex = await algolia.instance.index('contacts_copy_1').deleteIndex();
    taskDeleteIndex = await algolia.instance.index('contacts_copy_2').deleteIndex();
  ...
  group('15. Perform Query', () {
    test('1. Perform Query', () async {
      var query = algolia.instance.index('contacts').search('john');
    ...
    test('2. Perform SimilarQuery', () async {
      var query = algolia.instance.index('contacts').setSimilarQuery('775');
  ...
  test('2. Perform AttributesForFaceting', () async {
    var settings = algolia.instance.index('contacts').settings.setAttributesForFaceting(['name', 'searchable(email)']);
  ...
  test('3. Perform UnretrievableAttributes', () async {
    var settings = algolia.instance.index('contacts').settings.setUnRetrievableAttributes(['isDelete']);
  ...
  test('2. Perform custom ranking', () async {
    var settings = algolia.instance.index('contacts').settings.setCustomRanking(['asc(createdAt)']);
  ...
  test('1. Perform attributes To Highlight', () async {
    var settings = algolia.instance.index('contacts').settings.setAttributesToHighlight(['email']);
  ...
  test('2. Perform attributes To Snippet', () async {
    var settings = algolia.instance.index('contacts').settings.setAttributesToSnippet(['contact']);
  ...
  test('3. Perform highlight Pre Tag & highlight Post Tag', () async {
    var settings = algolia.instance.index('contacts').settings.setHighlightPreTag('<em>').setHighlightPostTag('</em>');
  ...
  test('4. Perform restrict Highlight And Snippet Arrays', () async {
    var settings = algolia.instance.index('contacts').settings.setRestrictHighlightAndSnippetArrays(enable: true);
